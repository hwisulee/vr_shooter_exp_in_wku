...
public class LocomotionSampleSupport : MonoBehaviour
{
    ...
    void SetupNodeTeleport()
    {
        ...
        ActivateHandlers<TeleportInputHandlerTouch, TeleportAimHandlerLaser, TeleportTargetHandlerNavMesh, TeleportOrientationHandlerThumbstick, TeleportTransitionBlink>();
        var input = TeleportController.GetComponent<TeleportInputHandlerTouch>();
